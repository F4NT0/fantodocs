...
<Aside type="tip" title="Resumo" icon="seti:c-sharp">
    - Operadores são símbolos matemáticos para diferentes processos na linguagem
    - São divididos nos seguintes tipos:
        - <span style="color: orange">Aritméticos</span> → Cálculos Matemáticos.
        - <span style="color: orange">Atribuição</span> → Reutilização de valores para cálculos.
        - <span style="color: orange">Comparação</span> → Verificações entre valores.
        - <span style="color: orange">Condicionais</span> → Verificação booleana entre valores (true ou false).
        - <span style="color: orange">Incremento e Decremento</span> → Aumentar ou diminuir um valor por vez.
        - <span style="color: orange">Lógicos</span> → Verificação lógica entre valores para um processo.
</Aside>
